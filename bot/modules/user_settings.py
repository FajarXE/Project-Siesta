...
async def uset_cb(client, query, datatype=""):
    ...
    if data[1] == "back":
    ...
    elif data[1] == "tidal" or datatype == "tidal":
    ...
    elif data[1] == "qobuz" or datatype == "qobuz":
        ...
        current = user_dict.get("format", bot_set.qobuz.quality)
...
async def debug(c, m): # debugger
    ...
    await m.reply(dt_qb+dt_td, True)