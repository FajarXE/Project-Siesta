# [FILE BARU: bot/helpers/tidal/flac.py]
#
...
#
# (Kode FLAC lengkap dari file yang Anda unggah)
# ... (Saya akan memendekkannya di sini agar muat, 
#  tapi Anda harus menyalin SELURUH isi file flac.py) ...
#
...
def decode_file(inp, out, numsamples=None, seconds=None):
	...
	while numsamples > 0:
		# --- PERBAIKAN: Hentikan loop jika decode_frame mengembalikan False ---
		decoded_count = decode_frame(inp, numchannels, sampledepth, out)
		if not decoded_count:
			break
		numsamples -= decoded_count
		# --- AKHIR PERBAIKAN ---
